...
## 对话和菜单选择文本使用的颜色。
define gui.text_color = '#1C3144'
define gui.interface_text_color = '#ffffff'

define gui.textbox_height=50


## 字体和字体大小 #####################################################################

## 游戏内文本使用的字体
define gui.text_font = "AaTaoHuaShan-2.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "AaTaoHuaShan-2.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "AaTaoHuaShan-2.ttf"
...
## 标题菜单和游戏菜单使用的图像。
define gui.main_menu_background = "images/menu/left.png"
