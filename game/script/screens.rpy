...
init python:
    ...
    # 创建一个带透明度的背景图像
    gui.textbox_background = Transform(
        Frame("gui/textbox.png", 30, 20, 30, 20),
        alpha=1.0  # 0.0 ~ 1.0，0.6 表示 60% 不透明
    )
style window:
    xalign 0.5
    xfill True
...
screen main_menu():
    ...
    # 左侧装饰图（位于 images/menu/left.jpg）
    frame:
        xalign 0.0
        yalign 0.0
        yfill True
        background "images/menu/left.png"     # 高度填满（或设 ysize）

    # 右侧按钮区域（purple 背景 + 按钮）（位于 images/menu/purple.png）
    frame:
        xalign 1.0          # 右对齐
        xoffset 0       # 向左偏移 400px（根据 purple.png 宽度调整）
        yalign 0.0          # 垂直居中
        xsize 400            # purple.png 的宽度
        ysize 1100           # purple.png 的高度

        # purple 背景图
        add "images/menu/purple.png"
        ...
        vbox:
            ...
            add "images/menu/title.png"

            # 开始游戏按钮（位于 images/menu/start.png）
            imagebutton:
                idle "images/menu/start.png"
                hover "images/menu/start.png"
                action [ Play("sound", "audio/hover.mp3"), Start() ]

            # 读取游戏按钮（位于 images/menu/load.png）
            imagebutton:
                idle "images/menu/load.png"
                hover "images/menu/load.png"
                action [ Play("sound", "audio/hover.mp3"), ShowMenu("load") ]

            # 设置按钮（位于 images/menu/setting.png）
            imagebutton:
                idle "images/menu/setting.png"
                hover "images/menu/setting.png"
                action [ Play("sound", "audio/hover.mp3"), ShowMenu("preferences") ]

            # 关于按钮（位于 images/menu/about.png）
            imagebutton:
                idle "images/menu/about.png"
                hover "images/menu/about.png"
                action [ Play("sound", "audio/hover.mp3"), ShowMenu("about") ]

            # 帮助按钮（位于 images/menu/help.png）
            imagebutton:
                idle "images/menu/help.png"
                hover "images/menu/help.png"
                action [ Play("sound", "audio/hover.mp3"), ShowMenu("help") ]

            # 退出按钮（位于 images/menu/exit.png），仅在 PC 上显示
            if renpy.variant("pc"):
                imagebutton:
                    idle "images/menu/exit.png"
                    hover "images/menu/exit.png"
                    action [ Play("sound", "audio/hover.mp3"), Quit() ]
