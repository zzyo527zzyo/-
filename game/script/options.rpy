...
define config.name = _("罗坤桑の恋爱物语(demo)")
...
# options.rpy（推荐放这里）
define config.mouse = {
    "default": [ ("gui/cursor/pointer.png", 12, 12) ],
    "pressed_default": [ ("gui/cursor/pointer.png", 8, 8) ]
}
## 放置在游戏内“关于”屏幕上的文本。将文本放在三个引号之间，并在段落之间留出空
## 行。

define gui.about = _p("""
本文档为《羅坤桑さんの恋物語》Ren'Py 项目配置内容，仅用于个人学习交流，不涉商业用途。
请在获取后 24 小时内自行删除，勿留存、传播或作他用。
""")
...
default preferences.text_cps = 8
...
define config.save_directory = "luokunjiang-1762252648"
